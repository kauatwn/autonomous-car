...
| **LED Verde**                     | `D8`         | Saída Digital   | Indicação de Via Livre ($d \ge 30\text{ cm}$)            | Resistor limitador de 220 Ω no cátodo     |
| **LED Amarelo**                   | `D9`         | Saída Digital   | Indicação de Manobra Evasiva ($15 \le d < 30\text{ cm}$) | Resistor limitador de 220 Ω no cátodo     |
| **LED Vermelho**                  | `D10`        | Saída Digital   | Indicação de Proximidade Crítica ($d < 15\text{ cm}$)    | Resistor limitador de 220 Ω no cátodo     |
| **Buzzer Piezoelétrico**          | `D11`        | Saída Digital   | Sinal sonoro de alerta e manobra de ré                   | Terminal positivo no D11; GND no negativo |
